...
const COMMANDS = [
  ...
  { command: "say", label: "👋 Greeting", payload: { text: "Konichiwa!" } },
  { command: "say", label: "😴 Ask about Sleep", payload: { text: "How_was_your_sleep?" } },
  { command: "say", label: "🎨 Statement about Visualizations", payload: { text: "The_recommendations_stay_the_same, only_the_visualizations_change" } },
  { command: "say", label: "🤔 What do you like about the recommendations?", payload: { text: "would_do_you_like_a_recommendation?" } },
  { command: "say", label: "🤝 Do you agree?", payload: { text: "do_you_agree_with_this_choice?" } },
